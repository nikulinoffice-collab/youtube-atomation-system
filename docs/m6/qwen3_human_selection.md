...
This closes the earlier engine-direction objection caused by the robotic/emotionally detached Edge result. The human reviewer subsequently explicitly selected the tested male preset Aiden.
